...
const cardImages = [
  require('../assets/images/placeholder-avatar.png'), // Ideally replace with actual images
...
const gameLevels = [
  {
    ...
    cards: [
      { id: 1, value: 'T', color: '#FF5F6D', image: cardImages[0] },
      { id: 2, value: 'T', color: '#FF5F6D', image: cardImages[0] },
      { id: 3, value: 'E', color: '#FFC371', image: cardImages[1] },
      { id: 4, value: 'E', color: '#FFC371', image: cardImages[1] },
      { id: 5, value: 'A', color: '#11998e', image: cardImages[2] },
      { id: 6, value: 'A', color: '#11998e', image: cardImages[2] },
      { id: 7, value: 'M', color: '#38ef7d', image: cardImages[3] },
      { id: 8, value: 'M', color: '#38ef7d', image: cardImages[3] },
      { id: 9, value: 'X', color: '#6a11cb', image: cardImages[4] },
      { id: 10, value: 'X', color: '#6a11cb', image: cardImages[4] },
      { id: 11, value: 'Y', color: '#2575fc', image: cardImages[5] },
      { id: 12, value: 'Y', color: '#2575fc', image: cardImages[5] },
      { id: 13, value: 'Z', color: '#3494E6', image: cardImages[6] },
      { id: 14, value: 'Z', color: '#3494E6', image: cardImages[6] },
      { id: 15, value: 'W', color: '#EC6EAD', image: cardImages[7] },
      { id: 16, value: 'W', color: '#EC6EAD', image: cardImages[7] },
    ],
  },
  {
    level: 2,
    ...
    cards: [
      { id: 17, value: 'L', color: '#FBD786', image: cardImages[0] },
      { id: 18, value: 'L', color: '#FBD786', image: cardImages[0] },
      { id: 19, value: 'E', color: '#f5af19', image: cardImages[1] },
      { id: 20, value: 'E', color: '#f5af19', image: cardImages[1] },
      { id: 21, value: 'A', color: '#43cea2', image: cardImages[2] },
      { id: 22, value: 'A', color: '#43cea2', image: cardImages[2] },
      { id: 23, value: 'R', color: '#185a9d', image: cardImages[3] },
      { id: 24, value: 'R', color: '#185a9d', image: cardImages[3] },
      { id: 25, value: 'N', color: '#F86CA7', image: cardImages[4] },
      { id: 26, value: 'N', color: '#F86CA7', image: cardImages[4] },
      { id: 27, value: 'X', color: '#F4D444', image: cardImages[5] },
      { id: 28, value: 'X', color: '#F4D444', image: cardImages[5] },
      { id: 29, value: 'Y', color: '#3494E6', image: cardImages[6] },
      { id: 30, value: 'Y', color: '#3494E6', image: cardImages[6] },
      { id: 31, value: 'Z', color: '#EC6EAD', image: cardImages[7] },
      { id: 32, value: 'Z', color: '#EC6EAD', image: cardImages[7] },
    ],
  },
  {
    level: 3,
    ...
    cards: [
      { id: 33, value: 'F', color: '#00b09b', image: cardImages[0] },
      { id: 34, value: 'F', color: '#00b09b', image: cardImages[0] },
      { id: 35, value: 'L', color: '#96c93d', image: cardImages[1] },
      { id: 36, value: 'L', color: '#96c93d', image: cardImages[1] },
      { id: 37, value: 'U', color: '#FDC830', image: cardImages[2] },
      { id: 38, value: 'U', color: '#FDC830', image: cardImages[2] },
      { id: 39, value: 'E', color: '#F37335', image: cardImages[3] },
      { id: 40, value: 'E', color: '#F37335', image: cardImages[3] },
      { id: 41, value: 'N', color: '#654ea3', image: cardImages[4] },
      { id: 42, value: 'N', color: '#654ea3', image: cardImages[4] },
      { id: 43, value: 'T', color: '#eaafc8', image: cardImages[5] },
      { id: 44, value: 'T', color: '#eaafc8', image: cardImages[5] },
      { id: 45, value: 'X', color: '#00F260', image: cardImages[6] },
      { id: 46, value: 'X', color: '#00F260', image: cardImages[6] },
      { id: 47, value: 'Y', color: '#0575E6', image: cardImages[7] },
      { id: 48, value: 'Y', color: '#0575E6', image: cardImages[7] },
    ],
  },
];
